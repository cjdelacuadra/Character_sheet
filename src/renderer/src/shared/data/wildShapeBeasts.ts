...
export let WILD_SHAPE_BEASTS: WildShapeBeast[] = [
  // ── CR 1/4 ──────────────────────────────────────────────────────────────
  { id: 'wolf', name: 'Wolf', source: 'PHB', cr: 0.25, hp: 11, ac: 13, speed: '40 ft',
    attacks: [{ name: 'Bite', toHit: 4, dmg: '2d4+2', dmgType: 'piercing', note: 'DC 11 STR save or prone' }] },
  { id: 'panther', name: 'Panther', source: 'PHB', cr: 0.25, hp: 13, ac: 12, speed: '50 ft, climb 40',
    attacks: [
  ...
  // ── CR 2 ────────────────────────────────────────────────────────────────
  { id: 'polar-bear', name: 'Polar Bear', source: 'PHB', cr: 2, hp: 42, ac: 12, speed: '40 ft, swim 30',
    multiattack: 'Bite + Claws',
    attacks: [
      { name: 'Bite', toHit: 7, dmg: '1d8+5', dmgType: 'piercing' },
      { name: 'Claws', toHit: 7, dmg: '2d6+5', dmgType: 'slashing' },
    ] },
  { id: 'giant-constrictor-snake', name: 'Giant Constrictor Snake', source: 'PHB', cr: 2, hp: 60, ac: 12, speed: '30 ft, swim 30',
    attacks: [
  ...
  { id: 'saber-toothed-tiger', name: 'Saber-Toothed Tiger', source: 'PHB', cr: 2, hp: 52, ac: 12, speed: '40 ft',
    attacks: [
  ...
  // ── CR 3 ────────────────────────────────────────────────────────────────
  { id: 'killer-whale', name: 'Killer Whale', source: 'PHB', cr: 3, hp: 90, ac: 12, speed: 'swim 60',
    attacks: [{ name: 'Bite', toHit: 6, dmg: '5d6+4', dmgType: 'piercing' }] },
  { id: 'giant-scorpion', name: 'Giant Scorpion', source: 'PHB', cr: 3, hp: 52, ac: 15, speed: '40 ft',
  ...
  { id: 'elephant', name: 'Elephant', source: 'PHB', cr: 4, hp: 76, ac: 12, speed: '40 ft',
    attacks: [
  ...
  { id: 'giant-crocodile', name: 'Giant Crocodile', source: 'PHB', cr: 5, hp: 85, ac: 14, speed: '30 ft, swim 50',
  ...
  { id: 'mammoth', name: 'Mammoth', source: 'PHB', cr: 6, hp: 126, ac: 13, speed: '40 ft',
    attacks: [
