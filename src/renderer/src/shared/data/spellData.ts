...
export interface SpellEntry {
  ...
  vizCategory?: 'self-buff' | 'debuff-aura'
...
export const SPELLS: SpellEntry[] = [
  ...
  { id: 'hex',              name: 'Hex',                level: 1, school: 'Enchantment',   castingTime: '1 bonus action', range: '90ft', components: 'V, S, M (eye of newt)', duration: 'Concentration, 1 hour', concentration: true, description: 'You place a curse on a creature. Until the spell ends, you deal an extra 1d6 necrotic damage whenever you hit that target with an attack, and the target has disadvantage on ability checks using one ability score you choose. If the target drops to 0 HP, you can use a bonus action to move the hex.', classes: ['Warlock'], attackBuff: { bonusDmg: '1d6', bonusDmgType: 'necrotic' }, vizCategory: 'debuff-aura', vizDamageType: 'necrotic', attackType: 'auto-hit' },
  { id: 'hunter-s-mark',   name: "Hunter's Mark",       level: 1, school: 'Divination',    castingTime: '1 bonus action', range: '90ft', components: 'V', duration: 'Concentration, 1 hour', concentration: true, description: "You choose a creature and mystically mark it as your quarry. Until the spell ends, you deal an extra 1d6 damage to the target whenever you hit it with a weapon attack, and you have advantage on Perception and Survival checks to find it. If the target drops to 0 HP, you can use a bonus action to mark a new creature.", classes: ['Ranger'], attackBuff: { bonusDmg: '1d6', bonusDmgType: 'weapon' }, vizCategory: 'debuff-aura', vizDamageType: 'force', attackType: 'auto-hit' },
  ...
  { id: 'divine-favor',     name: 'Divine Favor',       level: 1, school: 'Evocation',     castingTime: '1 bonus action', range: 'Self', components: 'V, S', duration: 'Concentration, 1 minute', concentration: true, description: "Your prayer empowers you with divine radiance. Until the spell ends, your weapon attacks deal an extra 1d4 radiant damage on a hit.", classes: ['Paladin'], attackBuff: { bonusDmg: '1d4', bonusDmgType: 'radiant' }, vizCategory: 'self-buff', vizDamageType: 'radiant' },
  ...
  { id: 'mirror-image',     name: 'Mirror Image',       level: 2, school: 'Illusion',      castingTime: '1 action', range: 'Self', components: 'V, S', duration: '1 minute', concentration: false, description: 'Three illusory duplicates of yourself appear in your space. Until the spell ends, whenever a creature targets you with an attack, roll a d20 to determine whether the attack targets you or one of your duplicates. Duplicates are destroyed when hit and disappear when the spell ends.', classes: ['Sorcerer', 'Warlock', 'Wizard'], vizCategory: 'self-buff', vizDamageType: 'psychic' },
