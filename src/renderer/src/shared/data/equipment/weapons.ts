...
export let WEAPONS: WeaponEquipmentItem[] = [
  ...
  // ── Magic (+2) — Rare ────────────────────────────────────────────────────
  { id: 'shortsword+2',  name: 'Shortsword +2',  kind: 'weapon', damageDie: '1d6',  damageType: 'piercing',    proficiencyCategory: 'Martial', rangeType: 'Melee',           properties: ['Finesse', 'Light'],                          enchantmentBonus: 2, isMonkWeapon: true, rarity: 'rare',      requiresAttunement: true, cost: 4000  },
  { id: 'longsword+2',   name: 'Longsword +2',   kind: 'weapon', damageDie: '1d8',  damageType: 'slashing',    proficiencyCategory: 'Martial', rangeType: 'Melee',           properties: ['Versatile (1d10)'],                          enchantmentBonus: 2,                    rarity: 'rare',      requiresAttunement: true, cost: 4000  },
  { id: 'greatsword+2',  name: 'Greatsword +2',  kind: 'weapon', damageDie: '2d6',  damageType: 'slashing',    proficiencyCategory: 'Martial', rangeType: 'Melee',           properties: ['Heavy', 'Two-Handed'],                       enchantmentBonus: 2,                    rarity: 'rare',      requiresAttunement: true, cost: 4000  },
  { id: 'longbow+2',     name: 'Longbow +2',     kind: 'weapon', damageDie: '1d8',  damageType: 'piercing',    proficiencyCategory: 'Martial', rangeType: 'Ranged',          properties: ['Ammunition (range 150/600)', 'Heavy', 'Two-Handed'], enchantmentBonus: 2,              rarity: 'rare',      requiresAttunement: true, cost: 4000  },
  // ── Magic (+3) — Very Rare ───────────────────────────────────────────────
  { id: 'longsword+3',   name: 'Longsword +3',   kind: 'weapon', damageDie: '1d8',  damageType: 'slashing',    proficiencyCategory: 'Martial', rangeType: 'Melee',           properties: ['Versatile (1d10)'],                          enchantmentBonus: 3,                    rarity: 'very rare', requiresAttunement: true, cost: 16000 },
  { id: 'greatsword+3',  name: 'Greatsword +3',  kind: 'weapon', damageDie: '2d6',  damageType: 'slashing',    proficiencyCategory: 'Martial', rangeType: 'Melee',           properties: ['Heavy', 'Two-Handed'],                       enchantmentBonus: 3,                    rarity: 'very rare', requiresAttunement: true, cost: 16000 },
]
